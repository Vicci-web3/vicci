...
export namespace SushiswapV3MainnetTypes {
...
export type _TokenWhitelist_orderBy =
  ...
  /** null **/
  protocol: InContextSdkMethod<DexAmmProtocol, QueryprotocolArgs, MeshContext>,
  /** null **/
  protocols: InContextSdkMethod<[DexAmmProtocol!]!, QueryprotocolsArgs, MeshContext>,
  /** Access to subgraph metadata **/
  ...
  /** null **/
  protocol: InContextSdkMethod<DexAmmProtocol, SubscriptionprotocolArgs, MeshContext>,
  /** null **/
  protocols: InContextSdkMethod<[DexAmmProtocol!]!, SubscriptionprotocolsArgs, MeshContext>,
  /** Access to subgraph metadata **/
  _meta: InContextSdkMethod<Subscription['_meta'], Subscription_metaArgs, MeshContext>
  };

  export type Context = {
      ["sushiswap-v3-mainnet"]: { Query: QuerySdk, Mutation: MutationSdk, Subscription: SubscriptionSdk },
